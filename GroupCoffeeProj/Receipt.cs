...
namespace GroupCoffeeProj
{
	...
	{
		public static decimal PrintReceipt(List<Items>listOrdered, decimal amountRemaining)
		{
            ...
            Console.WriteLine(String.Format("{0,15} {1,6:c}", "Your Change: ", amountRemaining));
            Console.WriteLine("\n\n\n");
            return grandTotal;
